...
async function get(req, res) {
    if (!req.isAuthenticated()) {
        renderFile(req, res, 'login.ejs', { req: req, res: res, user: undefined, isAuthenticated: false });
    } else {
        ...
        renderFile(req, res, 'login.ejs', { req: req, res: res, user: userReq, role: roles, mongoData: user, isAuthenticated: true });
    }
}
